...
function Procurements({ userDetails }) {
  ...
  useEffect(() => {
    if (reqId) {
      // Fetch procurement details or perform any action when the id changes
      console.log(`Fetching data for procurement ID: ${reqId}`);
      axios
        .get(`${baseUrl}requisitions/${reqId}`)
        .then((response) => {
          ...
          const formData = {
            ...
            RequestorInformation: {
              ...
              Designation: data.requestor.designation,
              Department: data.requestor.department,
              ExpensesType: data.expenseType,
              ReasonForPurchase: data.purpose,
            },
            SupplierVendorInformation: {
              Name: data.supplierVendorInformation.name,
              Address: data.supplierVendorInformation.address,
              PhoneNumber: data.supplierVendorInformation.phoneNumber,
              ContactPerson: data.supplierVendorInformation.contactPerson,
              ExpectedDeliveryDate: "", // Assuming this is missing in the response, add default or fetch separately
            },
            Items: data.items.map((item) => ({
              item: item.productDescription,
              quantity: item.quantity,
              unitPrice: "", // Assuming this is missing in the response, add default or calculate if needed
              totalPrice: item.total,
            })),
          };

          // Use the reset function to patch the form
          reset(formData);
        })
        .catch((error) => {
  ...
  const onSubmit = async (data) => {
    const payload = {
      requisitionNo: data?.RequisitionNo,
      requisitionDate: data?.RequisitionDate, // Extracting just the date part
      requestor: localStorage.getItem("userId"),
      requestType: data?.RequestorInformation.Designation, // Assuming requestType maps to Designation
      expenseType: data?.RequestorInformation.ExpensesType,
      purpose: data?.RequestorInformation.ReasonForPurchase,
      supplierVendorInformation: {
        name: data?.SupplierVendorInformation.Name,
        address: data?.SupplierVendorInformation.Address,
        phoneNumber: data?.SupplierVendorInformation.PhoneNumber,
      ...
      items: data?.Items.map((item) => ({
        ...
        quantity: item.quantity,
        units: "unit", // Assuming a static value for units
        preferredMfr: "", // If there's no mapping, leave it empty or set a default
        total: item.totalPrice,
        remarks: "", // If there's no mapping, leave it empty or set a default
      })),
    };

    try {
      const response = await axios.post(`${baseUrl}requisitions`, payload, {
          ...
          <Link to="/Main/UserRequests">
            <button className="back-button-text">
              ...
              >
                <path
                  d="M15 4L7 12L15 20"
                  stroke="url(#paint0_linear_64_844)"
                  strokeWidth="1.5"
                  strokeLinecap="round"
        ...
        <form className="Requisition-form" onSubmit={handleSubmit(onSubmit)}>
          <div className="procurements-section">
            <h1 className="section-title">
              Requisition Information<span className="star">*</span>
            </h1>
            <div className="field-group">
              <div className="field-item">
                <label className="field-label">Requisition Number</label>
            ...
            <div className="field-group">
              <div className="field-item">
                ...
                <input
                  type="text"
                  className="field-input"
                  {...register("RequestorInformation.Name")}
                />
              ...
              <div className="field-item" style={{ marginLeft: "20px" }}>
                ...
                <input
                  type="text"
                  className="field-input"
                  {...register("RequestorInformation.Designation")}
                />
              ...
              <div className="field-item" style={{ marginLeft: "20px" }}>
                ...
                <input
                  type="text"
                  className="field-input"
                  {...register("RequestorInformation.Department")}
                />
          ...
          <div className="procurements-section expenses-section">
            <h1 className="section-title">
              Expenses Information<span className="star">*</span>
            </h1>
            <div className="field-group">
              <div className="field-item">
                <label className="field-label">Expense Type</label>
                <input
                  type="text"
                  className="field-input"
                  {...register("RequestorInformation.ExpensesType")}
                />
            ...
            <div className="field-group">
              <div className="field-item">
                ...
                <textarea
                  ...
                  rows="15"
                  {...register("RequestorInformation.ReasonForPurchase")}
                ></textarea>
          ...
          <div className="procurements-section procurement-request">
            <h1 className="section-title">
              Procurement Request<span className="star">*</span>
            </h1>
          ...
          <div className="procurements-section vendor-information">
            <h1 className="section-title">
              Vendor Information<span className="optional">(optional)</span>
            </h1>
            <div className="field-group">
              <div className="field-item">
                <label className="field-label">Name</label>
                <input
                  type="text"
                  className="field-input"
                  {...register("SupplierVendorInformation.Name")}
                />
              </div>
              <div className="field-item" style={{ marginLeft: "20px" }}>
                <label className="field-label">Address</label>
                <input
                  type="text"
                  className="field-input"
                  {...register("SupplierVendorInformation.Address")}
                />
              </div>
              <div className="field-item" style={{ marginLeft: "20px" }}>
                <label className="field-label">Phone Number</label>
                <input
                  type="text"
                  className="field-input"
                  {...register("SupplierVendorInformation.PhoneNumber")}
                />
              </div>
            </div>
            ...
            <div className="field-group">
              <div className="field-item">
                ...
                <input
                  type="text"
                  className="field-input"
                  {...register("SupplierVendorInformation.ContactPerson")}
                />
              </div>
              <div className="field-item" style={{ marginLeft: "20px" }}>
                <label className="field-label">Expected Delivery Date</label>
                <input
                  ...
                  className="field-input"
                  {...register(
                    "SupplierVendorInformation.ExpectedDeliveryDate"
                  )}
                />
              </div>
            </div>
